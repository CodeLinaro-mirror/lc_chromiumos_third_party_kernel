...
static int qnoc_probe(struct platform_device *pdev)
{
	...
	dev_info(&pdev->dev, "Registered SC7280 ICC\n");
...
static const struct of_device_id qnoc_of_match[] = {
	{ .compatible = "qcom,sc7280-aggre1_noc",
	  .data = &sc7280_aggre1_noc},
	{ .compatible = "qcom,sc7280-aggre2_noc",
	  .data = &sc7280_aggre2_noc},
	{ .compatible = "qcom,sc7280-clk_virt",
	  .data = &sc7280_clk_virt},
	{ .compatible = "qcom,sc7280-cnoc2",
	  .data = &sc7280_cnoc2},
	{ .compatible = "qcom,sc7280-cnoc3",
	  .data = &sc7280_cnoc3},
	{ .compatible = "qcom,sc7280-dc_noc",
	  .data = &sc7280_dc_noc},
	{ .compatible = "qcom,sc7280-gem_noc",
	  .data = &sc7280_gem_noc},
	{ .compatible = "qcom,sc7280-lpass_ag_noc",
	  .data = &sc7280_lpass_ag_noc},
	{ .compatible = "qcom,sc7280-mc_virt",
	  .data = &sc7280_mc_virt},
	{ .compatible = "qcom,sc7280-mmss_noc",
	  .data = &sc7280_mmss_noc},
	{ .compatible = "qcom,sc7280-nsp_noc",
	  .data = &sc7280_nsp_noc},
	{ .compatible = "qcom,sc7280-system_noc",
