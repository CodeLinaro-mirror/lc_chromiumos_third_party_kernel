...
/*
 * TODO: Check if the Mux closet op needs to be exposed in case the mux needs
 * to be set to 0x0 in case of Modem Reset.
 *   gcc_mss_q6ss_boot_clk_src - mux, controlled by GCC_MSS_Q6SS_BOOT_GPLL0_MUXR.
 *    During boot, select 0 (gpll0_clk_src)
 *    Post-boot, select 1 (clk_xo_src)
 *
 *    Master:
 *    0: gcc_xo_clk
 *    1: gcc_mss_pll0_main_div_clk_src
 */
