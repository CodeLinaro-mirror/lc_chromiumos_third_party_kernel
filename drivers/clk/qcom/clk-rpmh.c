...
DEFINE_CLK_RPMH_VRM(sc7280, ln_bb_clk2, ln_bb_clk2_ao, "lnbclka2", 2);
DEFINE_CLK_RPMH_VRM(sc7280, rf_clk1, rf_clk1_ao, "rfclka1", 1);
DEFINE_CLK_RPMH_VRM(sc7280, rf_clk3, rf_clk3_ao, "rfclka3", 1);
DEFINE_CLK_RPMH_VRM(sc7280, rf_clk4, rf_clk4_ao, "rfclka4", 1);
DEFINE_CLK_RPMH_BCM(sc7280, ipa, "IP0");
DEFINE_CLK_RPMH_BCM(sc7280, pka, "PKA0");
DEFINE_CLK_RPMH_BCM(sc7280, hwkm, "HK0");

static struct clk_hw *sc7280_rpmh_clocks[] = {
    [RPMH_CXO_CLK]      = &sc7280_bi_tcxo.hw,
    [RPMH_CXO_CLK_A]    = &sc7280_bi_tcxo_ao.hw,
    [RPMH_LN_BB_CLK2]   = &sc7280_ln_bb_clk2.hw,
    [RPMH_LN_BB_CLK2_A] = &sc7280_ln_bb_clk2_ao.hw,
    [RPMH_RF_CLK1]      = &sc7280_rf_clk1.hw,
    [RPMH_RF_CLK1_A]    = &sc7280_rf_clk1_ao.hw,
    [RPMH_RF_CLK3]      = &sc7280_rf_clk3.hw,
    [RPMH_RF_CLK3_A]    = &sc7280_rf_clk3_ao.hw,
    [RPMH_RF_CLK4]      = &sc7280_rf_clk4.hw,
    [RPMH_RF_CLK4_A]    = &sc7280_rf_clk4_ao.hw,
    [RPMH_IPA_CLK]      = &sc7280_ipa.hw,
    [RPMH_PKA_CLK]      = &sc7280_pka.hw,
    [RPMH_HWKM_CLK]     = &sc7280_hwkm.hw,
