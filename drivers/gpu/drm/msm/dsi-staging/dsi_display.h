...
static inline int dsi_display_get_active_displays(void **display_array,
	u32 max_display_count) { return 0; }
static inline int dsi_display_drm_bridge_init(struct dsi_display *display,
		struct drm_encoder *enc)
{
	return -EINVAL;
}
static inline int dsi_display_drm_bridge_deinit(struct dsi_display *display)
{
	return 0;
}

static inline int dsi_display_get_info(struct msm_display_info *info,
	void *disp)
{
	return -EINVAL;
}
