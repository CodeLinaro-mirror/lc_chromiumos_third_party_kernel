...
void ath11k_pcic_enable_ce_irqs_except_wake_irq(struct ath11k_base *ab)
{
	int i;
...
EXPORT_SYMBOL(ath11k_pcic_enable_ce_irqs_except_wake_irq);

void ath11k_pcic_disable_ce_irqs_except_wake_irq(struct ath11k_base *ab)
{
	int i;
	int irq_idx;
	struct ath11k_ce_pipe *ce_pipe;
...
EXPORT_SYMBOL(ath11k_pcic_disable_ce_irqs_except_wake_irq);
