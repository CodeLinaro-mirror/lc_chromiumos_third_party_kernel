...
static __always_inline void arch_raw_writeq(u64 val, volatile void __iomem *addr)
{
	asm volatile("str %x0, [%1]" : : "rZ" (val), "r" (addr));
}

static __always_inline u8 arch_raw_readb(const volatile void __iomem *addr)
{
	u8 val;
...
static __always_inline u16 arch_raw_readw(const volatile void __iomem *addr)
{
	u16 val;
...
static __always_inline u64 arch_raw_readq(const volatile void __iomem *addr)
{
	u64 val;
